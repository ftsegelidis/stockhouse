    ...
    private class AsyncFetch extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                url = new URL("http://"+IP+"/products/product-search.php");
        ...
        protected void onPostExecute(String result) {
            ...
            if(result.equals("no rows")) {
                Toast.makeText(SearchActivity.this, "0 Αποτελέσματα", Toast.LENGTH_LONG).show();
            }else{
                ...
                try {
                    ...
                    rvProduct = (RecyclerView) findViewById(R.id.productPriceList);
                    rvProduct = (RecyclerView) findViewById(R.id.productPriceList);
